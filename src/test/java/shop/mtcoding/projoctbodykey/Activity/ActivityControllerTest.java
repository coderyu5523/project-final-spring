...
//        System.out.println("statusCode : "+statusCode);
        ...
        actions.andExpect(jsonPath("$.status").value(200))
                ...
                .andExpect(jsonPath("$.body.dayAcitivityId").value(6))
...
//        System.out.println("statusCode : "+statusCode);
        ...
        actions.andExpect(jsonPath("$.status").value(200))
                ...
                .andExpect(jsonPath("$.body.totalMonthWalking").value(52353))
                .andExpect(jsonPath("$.body.avgMonthWalking").value(8725.5))
                .andExpect(jsonPath("$.body.rateAvgWalking").value(12.9))
                .andExpect(jsonPath("$.body.maxWalking").value(10000))
                .andExpect(jsonPath("$.body.maxWalkingDay").value("2024-05-20T15:00:00.000+00:00"))
