...
--        (1, 10031, 200, '2024-05-18'),
--        (1, 10028, 300, '2024-05-19'),
--        (1, 10008, 280, '2024-05-20'),
--        (1, 6122, 280, '2024-05-21'),
--        (1, 6020, 280, '2024-05-22'),
--        (1, 13030, 280, '2024-05-23'),
--        (1, 9532, 280, '2024-05-24'),
       (2, 1111, 100, '2024-05-13'),
       (2, 2222, 200, '2024-05-14')
--        (2, 3333, 300, '2024-05-15'),
--        (2, 3333, 300, '2024-05-16'),
--        (2, 3333, 300, '2024-05-17'),
--        (2, 3333, 300, '2024-05-18'),
--        (2, 3333, 300, '2024-05-19'),
--        (2, 3333, 300, '2024-05-20'),
--        (2, 3333, 300, '2024-05-21'),
--        (2, 3333, 300, '2024-05-22'),
--        (2, 3333, 300, '2024-05-23'),
--        (2, 3333, 300, '2024-05-24')
;

INSERT INTO bodydata_tb(user_id, weight, muscle, fat, created_at)
VALUES (1, 76.3, 21.5, 21.3, '2024-05-12 18:12'),
       (1, 76.3, 21.5, 21.3, '2024-05-13 18:12'),
--        (1, 75.8, 21.5, 21.3, '2024-05-14 19:32'),
--        (1, 75.8, 22.5, 20.3, '2024-05-15 17:33'),
--        (1, 75.5, 23.5, 19.3, '2024-05-19 19:08'),
--        (1, 75.1, 24.5, 18.3, '2024-05-21 16:53'),
--        (1, 74.8, 25.5, 17.3, '2024-05-23 20:03'),
       (2, 76.3, 21.5, 21.3, '2024-05-13 18:15'),
       (2, 75.3, 22.5, 20.3, '2024-05-14 18:15')
--        (2, 75.8, 22.5, 20.3, '2024-05-15 18:20'),
--        (2, 75.5, 23.5, 19.3, '2024-05-19 18:31'),
--        (2, 75.5, 23.5, 19.3, '2024-05-21 18:31'),
--        (2, 75.5, 23.5, 19.3, '2024-05-23 18:31')
;
...
values (1, 132, 1, '2024-05-22', '2024-06-21', false),
       (1, 320, 2, '2024-03-24', '2024-04-23', false),
       (1, 1800, 3, '2024-02-05', '2024-03-06', true),
       (1, 452, 4, '2024-05-18', '2024-06-17', true),
       (1, 3200, 5, '2024-04-23', '2024-04-24', false),
       (1, 328, 6, '2024-05-07', '2024-06-06', true),
       (1, 2500, 7, '2024-03-23', '2024-04-22', true),
       (1, 2500, 8, '2024-03-23', '2024-04-22', true),
       (1, 2500, 21, '2024-03-23', '2024-04-22', true),
       (1, 2500, 22, '2024-03-23', '2024-04-22', false),
       (1, 2500, 23, '2024-03-23', '2024-04-22', true),
       (1, 2500, 24, '2024-03-23', '2024-04-22', true),
       (1, 2500, 25, '2024-03-23', '2024-04-22', true),
       (1, 2500, 26, '2024-03-23', '2024-04-22', true),
       (1, 2500, 27, '2024-03-23', '2024-04-22', false),
       (1, 50000, 28, '2024-03-23', '2024-04-22', null),
       (2, 50000, 28, '2024-03-23', '2024-04-22', null)
;
