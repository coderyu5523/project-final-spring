...
VALUES ('ssar', '$2a$10$5Z2/Wx9Lc8jCDSOz9pd6FOSFa3rou4lkf9gzFFrSzddRibYJAafau', '010-0100-0100', '류재성', '1994-04-22', 'M', 178.5, '86d1375a-9cc3-47bc-a1a0-6561c01fa2e4_saram1.png', 500, 35.0, 12.0, 70.0, now()),
       ...
       ('love', '$2a$10$M119OnzkM1HHpZLCDIhrne4mYR9bwQWvRoHXvZMfh1Yxamf8UbmHq', '010-0033-0033', '김정수', '1996-08-13', 'M', 172.3, '86d1375a-9cc3-47bc-a1a0-6561c01fa2e4_saram1.png', 500, 26.9, 22.3, 73.8, now()),
       ('egdg', '$2a$10$M119OnzkM1HHpZLCDIhrne4mYR9bwQWvRoHXvZMfh1Yxamf8UbmHq', '010-0044-0044', '장유진', '1994-03-06', 'F', 163.7, '86d1375a-9cc3-47bc-a1a0-6561c01fa2e4_saram1.png', 500, 24.5, 21.4, 53.7, now()),
       ('hsj', '$2a$10$M119OnzkM1HHpZLCDIhrne4mYR9bwQWvRoHXvZMfh1Yxamf8UbmHq', '010-0055-0055', '공지영', '1996-10-08', 'F', 167.2, '86d1375a-9cc3-47bc-a1a0-6561c01fa2e4_saram1.png', 500, 23.4, 20.5, 55.2, now())
...
VALUES (1, 76.3, 21.5, 21.3, '2024-05-20 18:12'),
       (1, 76.3, 21.5, 21.3, '2024-05-21 18:12'),
       (1, 75.8, 21.5, 21.3, '2024-05-22 19:32'),
       (2, 76.3, 21.5, 21.3, '2024-05-20 18:15'),
       (2, 75.3, 22.5, 20.3, '2024-05-21 18:15'),
       (2, 75.8, 22.5, 20.3, '2024-05-22 18:20'),
       (3, 76.3, 21.5, 21.3, '2024-05-20 18:15'),
       (3, 75.3, 22.5, 20.3, '2024-05-21 18:15'),
       (3, 75.8, 22.5, 20.3, '2024-05-22 18:20'),
       (4, 76.3, 21.5, 21.3, '2024-05-20 18:15'),
       (4, 75.3, 22.5, 20.3, '2024-05-21 18:15'),
       (4, 75.8, 22.5, 20.3, '2024-05-22 18:20'),
       (5, 76.3, 21.5, 21.3, '2024-05-20 18:15'),
       (5, 75.3, 22.5, 20.3, '2024-05-21 18:15'),
       (5, 75.8, 22.5, 20.3, '2024-05-22 18:20');
...
values ('에베레스트', 'abf1c607-62c7-429d-9601-6edb1a3e4965_everest.png', '히말라야-네팔 8848.0m(약 2.7천층 올라감)', 350000,
       ...
       ('에베레스트 베이스캠프 트레킹', 'ab9dde60-6ce4-41f9-a848-aced82c5d38c_basecampEV.png', '히말라야-네팔 62.0km(약 8.7만개의 계단)', 300000,
        ...
        2, 30, '6200m', now()),
       ('칠쿠트 트레일', '270f40f2-683f-4a9a-be40-764e377847c6_chilkoot.png', '코스트산맥-알래스카 및 캐나다 53.0km(약 7.4만개의 계단)', 10000,
       ...
       ('산티아고 순례길', 'b97ca653-62da-47ce-9807-a4a882185a71_santiago.png', '피레네-프랑스 및 스페인 784.0km(약 110만개의 계단)', 200000,
        ...
        2, 30, '784K', now()),
       ('디날리', '2002831a-b5cd-4e4d-8527-2e0a53e6c7f4_denali.png', '알래스카산맥-미국 6190.0m(약 1.9천층 올라감)', 10000,
       ...
       ('올림푸스', '282416ba-af4c-460c-93e1-33014e52838b_olympus.png', '올림푸스산맥-그리스 에비아섬 2,917.0m(약 885층 올라감)', 190000,
        ...
        2, 30, '2917m', now()),
       ('투브칼 서킷', 'e1288507-5bc8-4821-b6f7-4d23d75d7610_toubkal.png', '아틀라스산맥-모로코 60.0km(약 8.4만개의 계단)', 10000,
