...
INSERT INTO question_choice_tb (survey_id, survey_question_id, choice_item, created_at)
VALUES
    (1, 1, '6시간 미만', now()),
    (1, 1, '6시간 - 8시간', now()),
    (1, 1, '8시간 이상', now()),
    (1, 1, '불규칙', now()),
    (1, 2, '잠을 못 자는 불면증', now()),
    (1, 2, '자주 깨어나는 불규칙한 수면', now()),
    (1, 2, '적절한 수면 시간을 확보하지 못하는 문제', now()),
    (1, 2, '낮에 지속되는 졸음과 낮잠을 못 자는 문제', now()),
    (1, 2, '면 중 호흡 장애로 인한 수면무호흡증', now()),
    (1, 3, '물', now()),
    (1, 3, '커피 또는 차', now()),
    (1, 3, '소프트 드링크 (음료수)', now()),
    (1, 3, '스포츠 음료', now()),
    (1, 4, '하루에 커피 한 잔 미만', now()),
    (1, 4, '하루에 커피 한 잔', now()),
    (1, 4, '하루에 커피 두 잔', now()),
    (1, 4, '하루에 커피 세 잔', now()),
    (1, 4, '하루에 커피 세 잔 이상', now()),
    (1, 5, '3끼 이상', now()),
    (1, 5, '3끼', now()),
    (1, 5, '2끼', now()),
    (1, 5, '1끼', now()),
    ...
    (1, 7, '3병 미만', now()),
    (1, 7, '4병 이상', now()),
    (1, 8, '유산소 운동 (예: 달리기, 수영, 자전거 타기)', now()),
    (1, 8, '근력 운동 (예: 웨이트 트레이닝, 스쿼트, 데드리프트)', now()),
    (1, 8, '요가 또는 필라테스', now()),
    (1, 8, '태권도, 복싱, 테니스 등의 무에타이 클래스', now()),
    (1, 8, '산책이나 등산', now()),
    (1, 9, '체중 감량과 체지방 감소', now()),
    (1, 9, '근육 강화와 체력 향상', now()),
    (1, 9, '스트레스 감소와 긴장 완화', now()),
    (1, 9, '더 나은 수면 품질과 수면 패턴 개선', now()),
    (1, 9, '자기 자신에 대한 자신감 증진', now()),
    (1, 9, '우울증 및 불안 감소', now()),
    (1, 10, '안전한 운동 수행', now()),
    (1, 10, '목표 달성을 위한 꾸준한 노력', now()),
    (1, 10, '적절한 영양 공급과 수분 섭취', now()),
    (1, 10, '적절한 휴식과 회복 시간 확보', now()),
    (1, 10, '몸의 신호를 듣고 적절한 휴식을 취하는 것', now()),
    (1, 10, '몸의 변화를 체감하며 기록하는 것', now()),
    (1, 11, '새벽', now()),
    (1, 11, '아침', now()),
    (1, 11, '오후', now()),
    (1, 11, '저녁', now()),
    ...
    (1, 13, '불규칙적으로', now()),
    (1, 14, '두통', now()),
    (1, 14, '소화 문제 (예: 속쓰림, 가슴 쓰림)', now()),
    (1, 14, '근육통', now()),
    (1, 14, '만성 피로', now()),
    (1, 14, '관절통', now()),
    (1, 14, '알레르기 반응 (예: 코막힘, 발진)', now()),
    (1, 14, '가슴 답답함', now()),
    (1, 15, '업무 압박과 업무 부담', now()),
    (1, 15, '인간관계 문제 (가족, 친구, 동료 등)', now()),
    (1, 15, '금전적인 문제 (예: 재정적 어려움, 빚)', now()),
    (1, 15, '건강 문제 (예: 질병, 만성 통증)', now()),
    (1, 15, '시간 관리의 어려움', now()),
    (1, 15, '불확실성과 불안감 (예: 미래에 대한 불안, 변화에 대한 불안)', now()),
    (1, 15, '업무와 개인 생활의 균형 유지의 어려움', now()),
    (1, 16, '운동 (예: 걷기, 요가, 수영)', now()),
    (1, 16, '명상 또는 호흡 운동', now()),
    (1, 16, '책 읽기 또는 음악 감상', now()),
    (1, 16, '친구나 가족과 대화하기', now()),
    (1, 16, '취미나 관심사에 집중하기 (예: 그림 그리기, 요리)', now()),
    (1, 16, '자연 속에서 휴식하기 (예: 산책, 피크닉)', now()),
    (1, 16, '정리하거나 정돈하기 (예: 집안 청소, 물건 정리)', now()),
    (1, 17, '균형 잡힌 식습관 유지', now()),
    (1, 17, '충분한 수면을 취하기', now()),
    (1, 17, '정기적인 운동 실천', now()),
    (1, 17, '스트레스 관리를 위한 활동 (예: 명상, 호흡 운동)', now()),
    (1, 17, '정기적인 건강 검진과 의료 상담', now()),
    (1, 17, '신체 활동 유지를 위한 일상적인 스트레칭과 운동', now()),
    (1, 17, '신체적인 증상이나 불편함을 주시하고 적절히 대응하기', now()),
    (1, 18, '건강 관련 앱 또는 웹사이트 (예: 건강 추적 앱, 온라인 건강 정보 사이트)', now()),
    (1, 18, '건강 관련 커뮤니티 또는 온라인 포럼', now()),
    (1, 18, '건강 전문가 (예: 의사, 영양사, 트레이너)', now()),
    (1, 18, '건강 도움을 주는 친구나 가족', now()),
    (1, 18, '건강 관리를 위한 책 또는 자료', now()),
    (1, 18, '건강 관리를 위한 오프라인 그룹 활동 (예: 요가 클래스, 걷기 모임)', now()),
    (1, 18, '건강 보험 혜택을 통한 건강 서비스 이용', now()),
    (1, 19, '체중 감량을 위한 다이어트 실천', now()),
    (1, 19, '규칙적인 운동을 통한 체력 향상', now()),
    (1, 19, '스트레스 관리를 위한 명상이나 호흡 운동 실천', now()),
    (1, 19, '균형 잡힌 식습관을 위한 식단 개선', now()),
    (1, 19, '건강한 수면 패턴 확립을 위한 노력', now()),
    (1, 19, '금연이나 음주량 줄이기와 같은 생활 습관 개선', now())
;