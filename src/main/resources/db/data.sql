...
VALUES (1, 1000, 100, '2024-04-27'),
       (1, 2000, 200, '2024-04-28'),
       (1, 3000, 200, '2024-04-29'),
       (1, 4000, 250, '2024-04-30'),
       (1, 5000, 240, '2024-05-01'),
       (1, 6000, 200, '2024-05-02'),
       (1, 7000, 300, '2024-05-03'),
       (1, 8000, 280, '2024-05-04'),
       (2, 1111, 100, '2024-04-27'),
       (2, 2222, 200, '2024-04-28'),
       (2, 3333, 300, '2024-04-29')
;

INSERT INTO bodydata_tb(user_id, weight, muscle, fat, created_at)
VALUES (1, 76.3, 21.5, 21.3, '2024-04-27 18:12'),
       (1, 75.8, 22.5, 20.3, '2024-04-28 17:33'),
       (1, 75.5, 23.5, 19.3, '2024-04-29 19:08'),
       (1, 75.1, 24.5, 18.3, '2024-04-30 16:53'),
       (1, 74.8, 25.5, 17.3, '2024-05-01 20:03'),
       (2, 76.3, 21.5, 21.3, '2024-04-27 18:15'),
       (2, 75.8, 22.5, 20.3, '2024-04-28 18:20'),
       (2, 75.5, 23.5, 19.3, '2024-04-29 18:31')
;
